...
{
    public partial class MakerTrueOrFalse8 : Form
    {
        public MakerTrueOrFalse8()
        {
            InitializeComponent();
        }
        ...
        private void MakerTrueOrFalse8_Load(object sender, EventArgs e)
        {
        ...
        private async void pictureBox1_Click(object sender, EventArgs e)
        {
            if (CheckAnswer == true && CheckQuestion == true) //Kijkt of er een vraag is ingevuld en true of false is ingevuld
            {
                ...
                StreamWriter Question8 = new StreamWriter(Application.StartupPath + "\\info\\" + "Question8.txt");
                Question8.WriteLine(tboxVraag.Text);
                Question8.Close();

                //Slaat het Antwoord op in een text file
                StreamWriter Question8TrueFalse = new StreamWriter(Application.StartupPath + "\\info\\" + "Question8TrueFalse.txt");
                Question8TrueFalse.WriteLine(Answer);
                Question8TrueFalse.Close();

                this.Hide();
                MakerTrueOrFalse9 MakerTrueOrFalse9 = new MakerTrueOrFalse9();
                MakerTrueOrFalse9.Show();
            }
